                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '20vh' }}>
                        <form onSubmit={handleFormSubmit} style={{ width: '80%', maxWidth: '600px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <div style={{ marginBottom: '10px', width: '100%' }}>
                                <select value={country} onChange={handleCountryChange} style={{
                                    width: '100%',
                            ...
                            <div style={{ marginBottom: '10px', width: '100%' }}>
                                <select value={state} onChange={handleStateChange} style={{
                                    width: '100%',
                                    padding: '10px', // Add this property
                                    border: '1px solid #ccc', // Example border style
                                }}>
                            ...
                            <div style={{ marginBottom: '10px', width: '100%' }}>
                                <select value={city} onChange={handleCityChange} style={{
                                    width: '100%',
                                    padding: '10px', // Add this property
                                    border: '1px solid #ccc', // Example border style
                                }} >
                            ...
                            <div style={{ width: '100%' }}>
                                <button type="submit" style={{ width: '100%', backgroundColor: 'blue', color: 'white', padding: '10px', border: 'none', cursor: 'pointer' }}>GET CANDIDATE</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '20vh' }}>
                        <form onSubmit={(e) => handleFormSubmit2(e, country, state, city, selectedOption)} style={{ width: '80%', maxWidth: '600px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            <div style={{ marginBottom: '10px', width: '100%' }}>
                                ...
                                >
                                    <option value="">Select Your Inkhundla</option>
                                    {states}
                                </select>
                            </div>
                            <div style={{ marginBottom: '10px', width: '100%' }}>
