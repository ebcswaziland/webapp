      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        <div className="container-fluid">
          <Link className="navbar-brand" to="/">
            ...
            <div >
              EBC RESULTS CAPTURING <span style={{ marginLeft: "60%", textAlign: 'center' }}>{`${localStorage.getItem('COUNTRY')} ${localStorage.getItem('STATE')} ${localStorage.getItem('CITY')}`}</span>
